...
1. Restart the server from the console page
...
Need help? Reach out in our [Discord](https://apexnode.host/discord) or submit a [support ticket](https://dash.apexnode.host/tickets/create).
